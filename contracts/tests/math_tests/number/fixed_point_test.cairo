use contracts::libraries::math::numbers::fixed_point::{
    FixedQ64x96, IFixedQ64x96Impl, IFixedQ64x96Trait, ONE, HALF, MIN_SQRT_RATIO, MAX_SQRT_RATIO
};
...
fn test_uniswap_price_calculations() {
    ...
    let sqrt_price_current = IFixedQ64x96Impl::new(79228162514264337593543950336);  // sqrt2000 * 2^96
